...
public class HomeController {
    ...
    public String home(Model model, Authentication authentication){
        if(authentication != null){
            UserDto userDto = userService.getLoginUser(); //luam informatia de la user
            model.addAttribute("user", userDto); //trm informatia in partea de interfata
        }
    ...
    public String register(@RequestParam(value="registrationSuccess", required = false) String success, Model model){
        ...
        model.addAttribute("user", new RegistrationRequest()); //DTO cu parola; ->register.html
