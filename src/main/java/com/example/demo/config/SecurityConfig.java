    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
        http
                .authorizeHttpRequests(authConfig -> {
                    ...
                    authConfig.requestMatchers(HttpMethod.GET, "/roles").permitAll();   ////implementare
                    authConfig.anyRequest().authenticated();
                })

                //Daca vrem sa accesam ceva fara sa avem drept
                .formLogin(login -> {
                ...
                .logout(logout -> {
                    logout.logoutRequestMatcher(new AntPathRequestMatcher("/logout"));//endpoint
